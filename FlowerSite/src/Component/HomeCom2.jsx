...
const FlowerCatalog = () => {
  return (
    <div className="catalog-container">
      ...
      <p className="catalog-description">Choose from our most popular flower bouquets to send to any occasion. Next Day delivery is available on all our best selling flowers. Some can be delivered within hours of ordering.</p>
